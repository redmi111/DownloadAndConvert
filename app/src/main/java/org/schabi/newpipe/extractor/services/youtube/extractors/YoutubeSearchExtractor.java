...
public class YoutubeSearchExtractor extends SearchExtractor {
    ...
    public ListExtractor.InfoItemsPage<InfoItem> getInitialPage() throws ExtractionException {
        return new ListExtractor.InfoItemsPage<>(collectItems(doc), getNextPageUrl());
    }
    ...
    public ListExtractor.InfoItemsPage<InfoItem> getPage(String pageUrl) throws IOException, ExtractionException {
        ...
        return new ListExtractor.InfoItemsPage<>(collectItems(doc), getNextPageUrlFromCurrentUrl(pageUrl));
    }
