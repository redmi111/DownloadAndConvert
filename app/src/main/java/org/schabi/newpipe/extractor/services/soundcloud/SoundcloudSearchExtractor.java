...
public class SoundcloudSearchExtractor extends SearchExtractor {
    ...
    public ListExtractor.InfoItemsPage<InfoItem> getInitialPage() throws IOException, ExtractionException {
        return new ListExtractor.InfoItemsPage<>(collectItems(searchCollection), getNextPageUrl());
    }
    ...
    public ListExtractor.InfoItemsPage<InfoItem> getPage(String pageUrl) throws IOException, ExtractionException {
        ...
        return new ListExtractor.InfoItemsPage<>(collectItems(searchCollection), getNextPageUrlFromCurrentUrl(pageUrl));
    }
