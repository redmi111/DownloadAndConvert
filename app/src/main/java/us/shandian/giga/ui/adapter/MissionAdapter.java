...
//                    checkMasterButtonsVisibility();
    ...
    @Override
    public void onViewRecycled(@NonNull RecyclerView.ViewHolder view) {
    ...
    public void onBindViewHolder(@NonNull RecyclerView.ViewHolder view, @SuppressLint("RecyclerView") int pos) {
    ...
    private void updateProgress(ViewHolderItem h) {
        ...
        if (hasError) {
            ...
            h.status.setText(R.string.general_error);
...
//    }
    ...
    public void setLinear(boolean isLinear) {
        mLayout = R.layout.mission_item_linear;//isLinear ? R.layout.mission_item_linear : R.layout.mission_item;
    }
