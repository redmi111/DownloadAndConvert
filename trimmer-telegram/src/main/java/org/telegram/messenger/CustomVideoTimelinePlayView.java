...
//        progressRight = minProgressDiff;
    ...
    protected void onDraw(Canvas canvas) {
        ...
        drawableLeft.setBounds(startX - Utils.dp(getContext(), 8), Utils.dp(getContext(), 4) + (Utils.dp(getContext(), 44) - Utils.dp(getContext(), 18)) / 2,
                startX + Utils.dp(getContext(), 2), (Utils.dp(getContext(), 44) - Utils.dp(getContext(), 18)) / 2 + Utils.dp(getContext(), 18 + 4));
        ...
        canvas.drawRoundRect(rect3, Utils.dp(getContext(), 2), Utils.dp(getContext(), 2), paint);
        drawableRight.setBounds(endX + Utils.dp(getContext(), 2), Utils.dp(getContext(), 4) + (Utils.dp(getContext(), 44) - Utils.dp(getContext(), 18)) / 2,
                endX + Utils.dp(getContext(), 12), (Utils.dp(getContext(), 44) - Utils.dp(getContext(), 18)) / 2 + Utils.dp(getContext(), 18 + 4));
